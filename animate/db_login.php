...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn) {
        try {
            ...
            if ($admin) {
                // For testing, bypass password verification
                $success = true;
...
<body>
    <div class="login-container">
        ...
        <div class="info">
            <strong>Database Admin Credentials:</strong><br>
            Username: admin<br>
            Password: [Password is hashed in database]
        </div>
        ...
        <div class="direct-login">
            <a href="network_login.php">Click here for direct login (no credentials required)</a>
        </div>
    </div>
</body>
</html>